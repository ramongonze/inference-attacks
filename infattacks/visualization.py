...
class VisualizeRisk:
    ...
    def _build_graph(self, x, y, show_graph, save_graph, attack_type, sensitive=None):
    ...
    def _build_hist(self, title, hist_bin_size, hist_counts, save_hist, show_hist):
        histogram = dict()
    ...
    def plot_comb_qids_reid(self, show_graph=True, save_graph=None) -> None:
        """
        ...
        plt.hlines(prior, 1, self.attack.result_comb_qids_reid["num_qids"].max(), label="Prior")
        
        x = self.attack.result_comb_qids_reid["num_qids"]
        y = self.attack.result_comb_qids_reid["post_vul"]
        self._build_graph(x, y, show_graph, save_graph, "reid")

    def plot_comb_qids_ai(self, sensitive:str, show_graph=True, save_graph=None) -> None:
        """
        ...
        plt.hlines(prior, 1, self.attack.result_comb_qids_ai["num_qids"].max(), label="Prior")
        
        x = self.attack.result_comb_qids_ai["num_qids"]
        y = self.attack.result_comb_qids_ai["post_vul_"+sensitive]
        self._build_graph(x, y, show_graph, save_graph, "ai", sensitive=sensitive)

    def plot_hist_reid(self, qids, title, hist_bin_size=5, show_hist=True, save_hist=None):
        """
        ...
        self._build_hist(title, hist_bin_size, hist_counts, save_hist, show_hist)

    def plot_hist_ai(self, qids, sensitive:str, title, hist_bin_size=5, show_hist=True, save_hist=None):
        """
