...
class VisualizeRisk:
    ...
    def _build_graph(self, title, x, y, show_graph, save_graph, language):
    ...
    def plot_comb_qids_reid(self, title:str, show_graph=True, save_graph=None, language="en") -> None:
        """
        ...
        self._build_graph(title, x, y, show_graph, save_graph, language)

    def plot_comb_qids_ai(self, title:str, sensitive:str, show_graph=True, save_graph=None, language="en") -> None:
        """
